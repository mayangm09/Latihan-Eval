    ...
    <div class="flex-1 flex flex-col">
      ...
      <main class="p-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow">
          ...
          <a href="{{ route('mahasiswa.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2 rounded-md text-sm transition">Tambah Data</a>
            <!-- Search Bar -->
            <div class="relative w-64">
            <input id="searchInput" type="text" placeholder="Cari mahasiswa..." class="pl-10 pr-4 py-2 w-full border rounded-md focus:outline-none focus:ring focus:ring-indigo-300 text-sm">
          ...
          <table class="min-w-full border border-gray-300 text-sm rounded-md overflow-hidden">
            <thead>
              <tr class="bg-gray-100 text-center text-gray-600">
                ...
                <th class="px-5 py-3 border-b border-gray-300">NIM</th>
            ...
            <tbody id="mahasiswaTableBody">
              ...
              <tr class="hover:bg-gray-50 text-center">
                <td class="px-5 py-3 border-b border-gray-200">{{ $mhs['id']}}</td>
                <td class="px-5 py-3 border-b border-gray-200">{{ $mhs['nama']}}</td>
                <td class="px-5 py-3 border-b border-gray-200">{{ $mhs['nim']}}</td>
                <td class="px-5 py-3 border-b border-gray-200">{{ $mhs['email']}}</td>
                <td class="px-5 py-3 border-b border-gray-200">{{ $mhs['prodi']}}</td>
                <td class="px-5 py-3 border-b border-gray-200 flex justify-center space-x-3">
                  <!-- Tombol Edit -->
                  <a href="{{ route('mahasiswa.edit', $mhs['nim']) }}" class="bg-yellow-500 text-white px-2 py-1 rounded">Edit</a>
                  <!-- Tombol Hapus -->
