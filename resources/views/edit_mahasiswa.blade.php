...
<div class="flex min-h-screen">
  ...
  <div class="flex-1 flex items-center justify-center p-10 bg-gray-100">
    ...
    <h2 class="text-2xl font-bold mb-6 text-gray-700">Edit Data Mahasiswa</h2>
    ...
    @method('PUT')
      <div>
        ...
        <input type="text" name="nama" value="{{ $mahasiswa['nama'] }}" class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Contoh: Budi">
      </div>

      <div>
        <label class="block mb-1 font-medium text-gray-700">NIM</label>
        <input type="text" name="nim" value="{{ $mahasiswa['nim'] }}" class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Contoh: 12345678">
      </div>

      <div>
        <label class="block mb-1 font-medium text-gray-700">Email</label>
        <input type="email" name="email" value="{{ $mahasiswa['email'] }}" class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Contoh: budi@kampus.ac.id">
      </div>

      <div>
        <label class="block mb-1 font-medium text-gray-700">Prodi</label>
        <input type="text" name="prodi" value="{{ $mahasiswa['prodi'] }}" class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Contoh: Teknik Informatika">
      </div>
